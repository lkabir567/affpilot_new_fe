...
// Define validation schema with zod for login form
...
// Define the form schema with zod for registration form
...
// Define the form schema with Zod for reset password form
